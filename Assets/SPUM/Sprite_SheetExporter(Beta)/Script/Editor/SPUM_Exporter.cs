...
public class SPUM_ExporterEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            SPB.MakeObjNow();
            SPB._objectNow.transform.localScale = new Vector3(SPB._scaleFactor,SPB._scaleFactor,SPB._scaleFactor);
        }
        ...
        if(SPB.useTimer)
        {
            ...
            if(SPB.timer > SPB.timerForSave)
            {
                ...
                SPB.frameNowNumber++;
                if(SPB.frameNowNumber >= SPB._frameRate)
                {
        ...
        if(SPB._netAnimClip)
        {
            ...
            tAnimTimerFactor = 1 / (SPB._frameRate*1f);
